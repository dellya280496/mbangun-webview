...
<body class=" page-500-full-page">
    <div class="row" style="justify-content: center;padding-left: 20px;padding-right: 20px;">
        ...
        <div class="col-md-12">
            <div class=" details">
                <center>
                    <h3>Toko anda saat ini sudah terdaftar</h3>
                    <p style="color: #afadad;">Kini anda sudah dapat menambahkan produk klik di bawah untuk mulai mengelola toko.</p>
                </center>
            </div>
        </div>
        <div class="col-md-12">
            <div class=" details">
                <center>
                    <button onclick="kelolaToko()" class="btn btn-success">Kelola Toko Sekarang</button>
                </center>
            </div>
        </div>
    </div>
