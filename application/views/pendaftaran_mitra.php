...
<body>
                                                ...
                                                <div class="tab-content">
                                                    ...
                                                    <div class="tab-pane" id="tab3">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-4">
                                                                <select name="jenis_mitra" id="jenis_mitra" class="form-control" required="true">
                                                    ...
                                                    <div class="tab-pane" id="tab4">
                                                        Tekan tombol <strong>Submit</strong> jika anda yakin data yang dimasukkan telah sesuai.
    ...
    <script src="assets/pages/scripts/form-wizard-mitra.js?v=8" type="text/javascript"></script>
    ...
    <script>
        $(document).ready(function() {
            //                             $('select[name*="my_multi_select1"]').empty();
