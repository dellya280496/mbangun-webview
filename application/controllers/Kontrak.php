...
class Kontrak extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['default_img'] = $this->encode_img_base64('https://m-bangun.com/api-v2/assets/img/watermark-logo.jpeg');
        // var_dump($data['kontrak']['data']->id);
        // die;

        if ($data['kontrak']['data']->mitra_ttd == null) {
            $data['kontrak']['data']->mitra_ttd = $this->encode_img_base64('https://m-bangun.com/api-v2/assets/img/watermark-logo.jpeg');
        } else {
            $data['kontrak']['data']->mitra_ttd = $this->encode_img_base64('https://m-bangun.com/api-v2/assets/ttd/' . $data['kontrak']['data']->mitra_ttd);
        }

        if ($data['kontrak']['data']->user_ttd == null) {
            $data['kontrak']['data']->user_ttd = $this->encode_img_base64('https://m-bangun.com/api-v2/assets/img/watermark-logo.jpeg');
        } else {
            $data['kontrak']['data']->user_ttd = $this->encode_img_base64('https://m-bangun.com/api-v2/assets/ttd/' .  $data['kontrak']['data']->user_ttd);
        }

        if ($data['kontrak']['data']->mbangun_ttd == null) {
            $data['kontrak']['data']->mbangun_ttd = $this->encode_img_base64('https://m-bangun.com/api-v2/assets/img/watermark-logo.jpeg');
        } else {
            $data['kontrak']['data']->mbangun_ttd = $this->encode_img_base64('https://m-bangun.com/api-v2/assets/ttd/'. $data['kontrak']['data']->mbangun_ttd);
        }
    ...
    public function pdf()
    {
        ...
        if ($data['kontrak']->worker_signature == null) {
            $data['kontrak']->worker_signature = $this->encode_img_base64('https://m-bangun.com/api-v2/assets/img/watermark-logo.jpeg');
        } else {
        ...
        if ($data['kontrak']->owner_signature == null) {
            $data['kontrak']->owner_signature = $this->encode_img_base64('https://m-bangun.com/api-v2/assets/img/watermark-logo.jpeg');
        } else {
